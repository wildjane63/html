...
dns:
  ...
  nameserver:
    - 'https://dns.alidns.com/dns-query#主代理'
  nameserver-policy:
    ...
    '+.msftconnecttest.com,+.msftncsi.com': 'https://dns.alidns.com/dns-query#主代理'
    '+.googleapis.com,+.googleapis.cn': 'https://dns.alidns.com/dns-query#Google'
    'rule-set:Bahamut-Site': 'https://dns.alidns.com/dns-query#Bahamut'
    'rule-set:Bilibili-Site': 'https://dns.alidns.com/dns-query#Bilibili'
    'rule-set:Discord-Site': 'https://dns.alidns.com/dns-query#Discord'
    'rule-set:GoogleFCM-Site': 'https://dns.alidns.com/dns-query#GoogleFCM'
    'rule-set:Netflix-Site': 'https://dns.alidns.com/dns-query#Netflix'
    'rule-set:OpenAI-Site': 'https://dns.alidns.com/dns-query#OpenAI'
    'rule-set:Speedtest-Site': 'https://dns.alidns.com/dns-query#Speedtest'
    'rule-set:Spotify-Site': 'https://dns.alidns.com/dns-query#Spotify'
    'rule-set:Steam-Site': 'https://doh.pub/dns-query#Steam'
    'rule-set:Telegram-Site': 'https://dns.alidns.com/dns-query#Telegram'
    'rule-set:TikTok-Site': 'https://dns.alidns.com/dns-query#TikTok'
    'rule-set:Apple-Site': 'https://doh.pub/dns-query#Apple'
    'rule-set:Google-Site': 'https://dns.alidns.com/dns-query#Google'
    'rule-set:Microsoft-Site': 'https://doh.pub/dns-query#Microsoft'
    'rule-set:GFWList-Site': 'https://dns.alidns.com/dns-query#黑名单网站'
...
proxies:
  -
    name: HK-1
    type: vless
    server: hk1-r.ddns-link-b5.uk
    port: 10126
    uuid: 8AEA7733-7310-4238-AC7B-4AB151553198
    udp: true
  ...
  -
    ...
    ports: 5000-6000
    password: 8AEA7733-7310-4238-AC7B-4AB151553198
    udp: true
    skip-cert-verify: false
    sni: hk3.dexlos.com
  -
